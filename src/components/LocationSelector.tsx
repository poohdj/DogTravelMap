...
const styles: Record<string, React.CSSProperties> = {
  ...
  input: { flex: 1, border: 'none', padding: '12px', background: 'transparent', outline: 'none', fontSize: '0.92rem', minWidth: 0 },
  actionBtn: { border: 'none', background: '#2D3142', color: '#fff', padding: '0 20px', height: '48px', fontWeight: 700, cursor: 'pointer', flexShrink: 0, whiteSpace: 'nowrap' },
  secondaryActions: { display: 'flex', gap: '8px' },
  utilBtn: { flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', padding: '10px', background: '#fff', border: '1.5px solid #E2E8F0', borderRadius: '10px', fontSize: '0.85rem', fontWeight: 600, color: '#64748B', cursor: 'pointer', whiteSpace: 'nowrap' },
